    ...
    public RequirementDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Requirement target = (Requirement) object;
                    target.addRequirementChoice( (org.exolab.jmscts.requirements.RequirementChoice) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new org.exolab.jmscts.requirements.RequirementChoice();
            }
        } );
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.exolab.jmscts.requirements.RequirementChoiceDescriptor());
        desc.setRequired(true);
        ...
        desc.setValidator(fieldValidator);
    } //-- org.exolab.jmscts.requirements.RequirementDescriptor()
